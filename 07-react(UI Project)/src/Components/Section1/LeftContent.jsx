...
function LeftContent() {
  return (
    <div className='w-1/4 h-full flex flex-col justify-between'>
        <div class="max-w-sm mx-auto text-gray-800 p-4">
            <h2 class="text-3xl font-bold leading-tight  text-black">
                <span className='ml-2'>Prospective </span><br />
                <span class="bg-gray-200  px-2 rounded-full">customer</span> <br />
                <span className='ml-2'>segmentation</span>
            </h2>

            <p class="mt-4 ml-2 text-sm text-gray-600 leading-relaxed">
